	...
	<section>
		  <div >
				...
				<div class="section-heading">
				  <h2><span>Completed Reservations</span> </h2>
				</div>
				</center>
				<!-- Contact Form Area -->
...
function animateMarker(marker, coords, km_h)
{
	...
	function validateForm(){	
		...
		if(type.options[type.selectedIndex].text== '--select'){
			...
			if(nic.value==""){
				...
				listReservationsByOwnerCompleted();
			...
			if(nic.value==""){
				...
				listReservationsByFarmerCompleted();
	...
	function listAllReservationsCompleted(){
		$("#table tbody tr").remove();
		document.getElementById('tableDiv').style.display="none";
		$.ajax({
			url:'listAllReservationsCompleted.php',
			method:'POST',
			dataType: 'json',
		...
		function listReservationsByOwnerCompleted(){
		$("#table tbody tr").remove();
		document.getElementById('tableDiv').style.display="none";
		var cnic = document.getElementById("CNIC");
		$.ajax({
			url:'listReservationsByOwnerCompleted.php',
			method:'POST',
			data:{
				'nic':cnic.value,			
			},
		...
		function listReservationsByFarmerCompleted(){
		$("#table tbody tr").remove();
		document.getElementById('tableDiv').style.display="none";
		var cnic = document.getElementById("CNIC");
		$.ajax({
			url:'listReservationsByFarmerCompleted.php',
			method:'POST',
			data:{
				'nic':cnic.value,			
			},
